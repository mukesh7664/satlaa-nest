...
// AutoServices Template Sections
...
/**
 * Explicit section component registry (SSR-safe, used by SectionRenderer).
 *
 * Rules:
 ...
 */
export const SECTIONS: Record<string, React.FC<any>> = {
  ...
  RoundCollection: CategoriesSection,
};
