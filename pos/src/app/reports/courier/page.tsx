  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="grid grid-cols-3 gap-4">
        <StatCard label="Handled Orders" value={totals.orders.toString()} />
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-50">
            {loading ? (
              ...
              rows.map((r) => (
                <tr key={r.courierId} className="hover:bg-gray-50">
                  <td className="px-4 py-3 font-medium text-slate-700">{r.courierName}</td>
