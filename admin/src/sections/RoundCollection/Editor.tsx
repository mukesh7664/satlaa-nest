...
import { Button, IconButton, Stack, Paper, Typography, TextField, Select, MenuItem } from "@mui/material";
import { Add as AddIcon, Delete as DeleteIcon } from "@mui/icons-material";
import ShopifyImagePicker from "@/components/ShopifyImagePicker";
import LinkPicker from "@/components/admin/LinkPicker";

interface RoundCollectionItem {
  image?: string;
  title?: string;
  link?: string;
}

interface RoundCollectionEditorProps {
  data: {
    title?: string;
    items?: RoundCollectionItem[];
    bgType?: string;
    bgColor?: string;
    bgGradient?: string;
...
export const RoundCollectionEditor: React.FC<RoundCollectionEditorProps> = ({
  data,
  onChange,
}) => {
