  ...
  return (
    <div className="flex min-h-screen w-full bg-white font-sans">
      ...
      >
        ...
        {/* FANOSTYLE Small Branding at top */}
        <div className="absolute top-10 left-12 z-20 flex items-center space-x-2">
          ...
          <span className="text-xl font-black tracking-tighter text-white">FANOSTYLE</span>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden mb-12">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-black tracking-tighter text-gray-900 uppercase">FANOSTYLE</span>
            </div>
          </div>
          ...
          <div className="mt-12 text-center text-xs text-gray-500 font-bold opacity-80 uppercase tracking-widest">
            © 2026 FANOSTYLE TECHNOLOGIES INC. ALL RIGHTS RESERVED.
          </div>
        </div>
      </div>
    </div>
