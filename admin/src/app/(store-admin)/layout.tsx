...
const ROUTE_PERMISSIONS = [
  ...
  { key: "settings/domain-management", routes: ["/settings/domain-management"], label: "Domain Management" },
  ...
  { key: "settings/manage-subscription", routes: ["/settings/manage-subscription"], label: "Manage Subscription" },
